                    ...
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li class="active"><a href="{{ url('upload') }}">Upload Produk</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    @include('alert')
                    <form action="{{ url('uploadProduk') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" name="nama_produk" id="nama_produk"
                                aria-describedby="helpId" placeholder="Nama Produk" value="">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control form-control-sm" name="harga" id="harga"
                                aria-describedby="helpId" placeholder="Harga" value="">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control form-control-sm" name="jumlah" id="jumlah"
                                aria-describedby="helpId" placeholder="Jumlah" value="">
                        </div>
